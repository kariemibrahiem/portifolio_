...
import travel_link from "./projs/travel.png";
import mawhebtac_link from "./projs/mawhebtac.png";
import emlaazon_link from "./projs/emlaazon.png";
import clinizone_link from "./projs/clinizone.png";
import l2 from "./projs/l2_htls.png";
import l3 from "./projs/l3_task.png";

const mycard = [
    { title: "travel club", text: "full hostel , travel porject for hotels , transport  and entertainment companies ;  with admin , vendor dashboard and mobile app ", cat: "back", link: travel_link, more: "https://trvlgate.com/en/admin" },
    { title: "mawhebtac", text: "full for Talent discovery and casting platform for entertainment industry ; with admin , vendor dashboard and mobile app ", cat: "back", link: mawhebtac_link, more: "https://mawhebtac.com/admin/login" },
    { title: "emlaazon", text: "full LMS project for manage transactions between teacher and student  ; with admin dashboard and mobile app ", cat: "back", link: emlaazon_link, more: "https://platform2.egymoe.com/public/admin" },
    { title: "clinizone", text: "full back/front end project integrated with odoo external api handle more than 50k record; with admin dashboard  ", cat: "back", link: clinizone_link, more: "https://crm.clinizone.net/dashboard/medical-audit" },
